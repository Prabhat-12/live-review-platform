      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="space-y-3">
            ...
            <Button className="w-full bg-blue-600 hover:bg-blue-500 text-white font-medium" size="lg">
              Send magic link
            </Button>
          </div>
          ...
          <p className="text-center text-xs text-zinc-500">
            ...
            <a href="#" className="text-zinc-400 hover:text-zinc-300 underline underline-offset-4">
              Terms
            </a>{' '}
            and{' '}
            <a href="#" className="text-zinc-400 hover:text-zinc-300 underline underline-offset-4">
